...
const AreYouMember = () => {
    ...
    return <div className={styles.member}>
        ...
        <div className={styles.reviews}>
            <Image  src='/reviews/phoebe_larsen.jpg' alt={'phoebe_larsen'} width={150} height={150}></Image>
            <Image  src='/reviews/kathrine_udgaard.jpg' alt={'phoebe_larsen'} width={150} height={150}></Image>        
            <Image  src='/reviews/phoebe_larsen.jpg' alt={'phoebe_larsen'} width={150} height={150}></Image>
            <Image  src='/reviews/kathrine_udgaard.jpg' alt={'phoebe_larsen'} width={150} height={150}></Image>
        </div>
    </div>
